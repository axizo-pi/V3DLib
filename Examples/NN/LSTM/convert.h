...
bool same(qpu::vector const &lhs, lstm::vector const &rhs, int bit_diff = 0);
bool same(qpu::matrix const &lhs, lstm::matrix const &rhs, int bit_diff = 0);
//bool same(qpu::vector const &lhs, qpu::vector const &rhs, int bit_diff = 0);
bool same(lstm::vector const &lhs, lstm::vector const &rhs, int bit_diff = 0);
